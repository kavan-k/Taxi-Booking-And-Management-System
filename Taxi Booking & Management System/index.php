...
<head>
    <meta charset="UTF-8">
    <title>Taxi Booking & Management System</title>
    ...
    <div class="parallax foo">
       <?php include 'navbar.php';?>
        ...
        <div class="hero-text" style="font-size:50px text-align: center; position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: white;">
            ...
            <h1 class="animated rubberBand" >Taxi Management System</h1>
            <p>A management system where you can easily manage taxi</p>
            
            <?php if(isset($_SESSION['username'])==true) { ?>
            <a class="btn btn-success" style="text-align: center" href="booking.php">Book a Taxi</a>
            
            <?php } else{  ?>
            <a class="btn btn-success" style="text-align: center" href="login.php">Login To Book a Taxi</a> 
            <?php } ?>
