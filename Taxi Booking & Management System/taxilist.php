         ...
         <div class="row">
             ...
             <div class="col-md-6 foo">
                 <div class="page-header">
                    <h1 class="animated bounceIn" style="text-align: center;">Taxi List</h1>      
                  </div> 
                  <table class="table">
                    <thead>
                        <th>Taxi Picture</th>
                        <th>Taxi Registration No</th>
                    </thead>  
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="taxiprofile.php?busid=<?php echo $row["veh_id"]; ?>"> <?php echo $row["veh_reg"] ?></a></td>
                        </tr>
                    </tbody> 
                <?php } }?>
                </table>
